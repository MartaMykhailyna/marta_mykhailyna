(function Ant() {
  ...
  function renderSlides(slides) {
    ...
    // Отримання ширини слайда
    const tempElement = document.createElement('div');
    tempElement.innerHTML = slides[currentSlide];
    slideWidth = tempElement.firstChild.offsetWidth;
    ...
    if (window.innerWidth > 1200) {
      const thirdSlide = currentSlide + 2 >= slides.length ? 0 : currentSlide + 2;
